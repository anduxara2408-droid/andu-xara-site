...
# Le système de réductions complet
reductions_system = '''
...
# Insérer avant </body>
if '</body>' in content:
    new_content = content.replace('</body>', reductions_system + '\n</body>')
    
    # Sauvegarder
    with open('index.html', 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("✅ Système de réductions ajouté avec succès !")
else:
    print("❌ Balise </body> non trouvée")
