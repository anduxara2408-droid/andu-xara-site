#!/bin/bash
echo "🔧 APPLICATION DIRECTE DU CORRECTIF"

# Créer une sauvegarde
cp reductions.html reductions-backup-fix.html

# Ajouter le correctif avant </body>
sed -i '/<\/body>/i\
<!-- DEBUT CORRECTIF CODES PROMO -->\
...
<!-- FIN CORRECTIF CODES PROMO -->' reductions.html

echo "✅ Correctif appliqué directement à reductions.html"
