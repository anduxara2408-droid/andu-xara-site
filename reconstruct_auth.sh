...
echo "🔨 Reconstruction de auth.js à partir de la sauvegarde..."

# Restaurer la sauvegarde
cp auth.js.backup auth.js

# Ajouter signUp après signIn
sed -i '/async signIn(email, password) {/,/^    }/a\
\
...
# Ajouter les fonctions de parrainage après getErrorMessage
sed -i '/getErrorMessage(error) {/,/^    }/a\
\
...
echo "✅ auth.js reconstruit avec succès"
