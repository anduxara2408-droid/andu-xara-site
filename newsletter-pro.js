// Configuration SMTP Amen.fr - ESSAYONS DIFFÉRENTS PORTS
...
const transporter = nodemailer.createTransport({
  host: 'smtp.amen.fr', // Serveur SMTP Amen
  port: 587, // Port standard
  secure: false, // TLS
  auth: {
    user: 'contact@andu-xara.store', // Votre email professionnel
    pass: 'Adx.store@ContactCLIENT' // Mot de passe de contact@andu-xara.store
  },
  tls: {
    rejectUnauthorized: false // Important pour Amen
  }
});
